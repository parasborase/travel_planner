#include <fstream>
#include <iostream>    
#include <map>      //header provides the std::map container class, which is a part of the C++(STL)
#include <cstring>     //used for C-style string manipulation
#include "graphs.h"
#include "customers.h"
#include "admin.h"
#include <cstdlib>   //includes several general-purpose functions
#include <stdlib.h>
#include <ctime>
#include <iomanip>
//#include <bits/stdc++.h>
    ...
    if(success){
        ...
        switch(x){
            ...
            case 5: {
                ...
                cout<<"Built by Paras,Ayush & Swet\n";
                cout<<"Exitting now ...\n";
                break;
            }
            default: {
